import {
  ...
  NgoMembership, SupportTicket, AuditLog, SystemSettings, User, LeadershipMember
} from '../types';
...
export const INITIAL_MEMBERSHIPS: NgoMembership[] = [
  {
    ...
    orderId: 'order_mbr_7721',
    paymentId: 'pay_mbr_7721',
  ...
  },
  {
    ...
    orderId: 'order_mbr_8834',
    paymentId: 'pay_mbr_8834',
...
export const INITIAL_SYSTEM_SETTINGS: SystemSettings = {
  ...
  bankDetails: {
    accountName: 'M/S AL-SHUJAIAT FOUNDATION JAMMU & KASHMIR',
    accountNumber: '925010008902563',
    bankName: 'Axis Bank Ltd',
    ifscCode: 'UTIB0002378',
    branch: 'Larikpora, Awantipora, Pulwama, J&K - 192122',
    accountType: 'Savings Account',
    upiId: 'asfjk@axisbank',
...
export const INITIAL_LEADERSHIP_MEMBERS: LeadershipMember[] = [
  // ----------------------------------------------------
  // 1. BOARD OF TRUSTEES
  // ----------------------------------------------------
  {
    id: 'lead_001',
    slug: 'mohd-amin-ganai',
    name: 'Mohd Amin Ganai',
    role: 'Chairperson & Founder',
    category: 'trustee',
    bio: 'Founder and Chairperson providing visionary leadership, strategic governance, and steering humanitarian welfare, clean water access, and emergency relief programs across Jammu & Kashmir.',
    department: 'Board of Trustees',
    responsibilities: ['Overall Strategic Governance', 'Statutory Trust Compliance', 'Humanitarian Mission Alignment', 'Stakeholder & Community Relations'],
    education: 'Postgraduate in Public Administration & Social Development',
    professionalBackground: 'Over 20 years of humanitarian field leadership, community organizing, and rural development in Kashmir Valley.',
    email: 'president@asfjk.org',
    displayOrder: 1,
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
  ...
  },
  {
    ...
    name: 'Vice Chairperson (Seat)',
    role: 'Vice Chairperson',
    category: 'trustee',
    bio: 'Oversees organizational accountability, governance audits, and strategic program evaluations alongside the Board of Trustees.',
    department: 'Board of Trustees',
    responsibilities: ['Governance Oversight', 'Board Committee Leadership', 'Policy & Ethics Review'],
    education: 'Master of Law & Corporate Governance',
    professionalBackground: 'Senior legal and non-profit governance specialist.',
    email: 'governance@asfjk.org',
    displayOrder: 2,
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
    updatedAt: '2026-08-20T00:00:00Z'
  },
  {
    ...
    name: 'General Secretary (Seat)',
    role: 'General Secretary',
    category: 'trustee',
    bio: 'Responsible for statutory records, annual general meetings, institutional charter documentation, and regulatory filings.',
    department: 'Board of Trustees',
    responsibilities: ['Statutory Documentation', 'Trustee Minutes & Resolutions', 'Regulatory Reporting'],
    education: 'Chartered Secretary / Master of Business Administration',
    professionalBackground: 'Experienced institutional administrator with non-profit trust expertise.',
    email: 'secretary@asfjk.org',
    displayOrder: 3,
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
    updatedAt: '2026-08-20T00:00:00Z'
  ...
  {
    id: 'lead_004',
    slug: 'treasurer-trustee',
    name: 'Treasurer (Seat)',
    role: 'Treasurer',
    category: 'trustee',
    bio: 'Stewards financial integrity, fiscal policies, statutory audit oversight, and Section 80G / 12A exemption transparency.',
    department: 'Board of Trustees',
    responsibilities: ['Fiscal Policy & Internal Controls', 'Statutory Financial Audits', 'Banking & Asset Management'],
    education: 'Chartered Accountant (CA) / Fellow of ICAI',
    professionalBackground: '25+ years in financial auditing, non-profit tax governance, and balance sheet integrity.',
    email: 'treasurer@asfjk.org',
    displayOrder: 4,
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
    updatedAt: '2026-08-20T00:00:00Z'
  ...
  {
    id: 'lead_005',
    slug: 'board-trustee-1',
    name: 'Trustee Member (Seat)',
    role: 'Trustee',
    category: 'trustee',
    bio: 'Dedicated board member guiding community welfare, education advocacy, and orphan support programs across rural districts.',
    department: 'Board of Trustees',
    responsibilities: ['Educational Outreach Oversight', 'Beneficiary Welfare Review'],
    education: 'Master of Social Work (MSW)',
    professionalBackground: 'Decades of grassroots community leadership and rural education mentorship.',
    displayOrder: 5,
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
    updatedAt: '2026-08-20T00:00:00Z'
  ...
  {
    id: 'lead_006',
    slug: 'board-trustee-2',
    name: 'Trustee Member (Seat)',
    role: 'Trustee',
    category: 'trustee',
    bio: 'Board member overseeing public health initiatives, medical camp deployment, and emergency medical assistance funds.',
    department: 'Board of Trustees',
    responsibilities: ['Healthcare Program Governance', 'Disaster Relief Oversight'],
    education: 'Doctor of Medicine (MD) / Public Health',
    professionalBackground: 'Senior medical practitioner and rural healthcare advocate.',
    displayOrder: 6,
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
    updatedAt: '2026-08-20T00:00:00Z'
  ...
  {
    id: 'lead_007',
    slug: 'exec-mohd-amin-ganai',
    name: 'Mohd Amin Ganai',
    role: 'Executive Director & Director General',
    category: 'executive',
    bio: 'Leads day-to-day executive operations, field deployment directives, cross-district humanitarian initiatives, and team leadership.',
    department: 'Executive Office',
    responsibilities: ['Operational Leadership', 'Inter-Agency Coordination', 'Field Relief Command', 'Strategic Partnerships'],
    education: 'Postgraduate in Public Administration & Social Development',
    professionalBackground: 'Visionary leadership directing humanitarian initiatives and sustainable development.',
    email: 'director@asfjk.org',
    displayOrder: 7,
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
    updatedAt: '2026-08-20T00:00:00Z'
  },
  {
    ...
    category: 'executive',
    bio: 'Oversees international donor alignment, cross-border development partnerships, and sustainable infrastructure grants.',
    department: 'International Programs',
    responsibilities: ['Global Donor Partnerships', 'Program Strategy', 'Institutional Grants'],
    education: 'M.Sc. in International Development & Global Governance (LSE)',
    professionalBackground: '18+ years directing international NGO programs and multi-lateral donor partnerships.',
    email: 'international@asfjk.org',
  ...
  },
  {
    ...
    slug: 'michael-carter',
    name: 'Michael Carter',
    role: 'Finance & Statutory Director',
    category: 'executive',
    bio: 'Chartered financial specialist managing statutory compliance, independent audit integrity, 80G tax exemptions, and 100% financial transparency.',
    department: 'Finance & Compliance',
    responsibilities: ['Statutory Financial Controls', 'Budgeting & Audit Reporting', 'Tax Compliance (80G/12A/FCRA)'],
    education: 'Chartered Accountant (FCA), B.Com (Hons)',
    professionalBackground: 'Former senior audit partner with extensive non-profit financial governance background.',
    email: 'finance@asfjk.org',
    linkedin: 'https://linkedin.com',
    displayOrder: 9,
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
  ...
  },
  {
    ...
    slug: 'sarah-mitchell',
    name: 'Sarah Mitchell',
    role: 'Director of Operations & Field Logistics',
    category: 'executive',
    bio: 'Manages rapid response logistics, mountain disaster relief dispatch, supply chain distribution, and strategic reserve warehouses.',
    department: 'Operations & Logistics',
    responsibilities: ['Field Supply Chain', 'Emergency Relief Dispatch', 'Warehouse Logistics'],
    education: 'Master in Humanitarian Logistics & Supply Chain Management',
    professionalBackground: 'Specialist in difficult terrain humanitarian access and emergency response coordination.',
    email: 'operations@asfjk.org',
    linkedin: 'https://linkedin.com',
    displayOrder: 10,
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
  ...
  },
  {
    ...
    category: 'executive',
    bio: 'Leads public relations, field reporting, educational advocacy, media relations, and transparent donor communications.',
    department: 'Communications',
    responsibilities: ['Media Relations', 'Annual Transparency Reports', 'Donor Communications'],
    education: 'M.A. in Media Communications & Public Affairs',
    professionalBackground: 'Award-winning humanitarian journalist and non-profit communications strategist.',
    email: 'communications@asfjk.org',
    linkedin: 'https://linkedin.com',
    displayOrder: 11,
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
  ...
  // ----------------------------------------------------
  {
    ...
    slug: 'daniel-wilson',
    name: 'Daniel Wilson',
    role: 'Senior Project Manager & Infrastructure Lead',
    category: 'team',
    bio: 'Senior civil and environmental engineer coordinating groundwater surveys, solar filtration plants, and community water committees across Kashmir.',
    department: 'Clean Water & Civil Engineering',
    responsibilities: ['Hydrogeological Surveying', 'Solar Filtration Construction', 'Quality Control & Testing'],
    education: 'B.Tech in Civil Engineering, M.Sc. in Water Resource Management',
    professionalBackground: '12+ years executing gravity-fed water projects and solar pump systems in mountainous areas.',
    email: 'projects@asfjk.org',
    displayOrder: 12,
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
    updatedAt: '2026-08-20T00:00:00Z'
  ...
  {
    id: 'lead_013',
    slug: 'program-lead-education',
    name: 'Education Program Lead (Seat)',
    role: 'Lead Coordinator - Youth & STEM Education',
    category: 'team',
    bio: 'Coordinates school sponsorships, digital smart lab installations, winter coaching centers, and orphan education tracking.',
    department: 'Education & Child Welfare',
    responsibilities: ['School Partnership Management', 'Student Scholarship Tracking', 'Digital Learning Curriculum'],
    education: 'Master of Education (M.Ed)',
    professionalBackground: 'Educator with specialized background in remote village school empowerment.',
    email: 'education@asfjk.org',
    displayOrder: 13,
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
    updatedAt: '2026-08-20T00:00:00Z'
  ...
  {
    id: 'lead_014',
    slug: 'field-health-coordinator',
    name: 'Healthcare Field Coordinator (Seat)',
    role: 'Community Health & Medical Camps Lead',
    category: 'team',
    bio: 'Directs mobile medical vans, free dispensary distribution, emergency medicine requests, and specialist doctor camps.',
    department: 'Healthcare & Medical Relief',
    responsibilities: ['Medical Camp Logistics', 'Medicine Stock Management', 'Patient Case Intake'],
    education: 'Bachelor of Science in Nursing / Public Health',
    professionalBackground: 'Clinical healthcare coordinator specializing in rural triage and medical outreach.',
    email: 'health@asfjk.org',
    displayOrder: 14,
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
    updatedAt: '2026-08-20T00:00:00Z'
  ...
  {
    id: 'lead_015',
    slug: 'senior-hydrology-advisor',
    name: 'Senior Hydrogeology Advisor (Seat)',
    role: 'Advisor - Water Security & Environmental Sustainability',
    category: 'advisor',
    bio: 'Provides technical guidance on aquifer recharge, Himalayan watershed conservation, and solar filtration sustainability.',
    department: 'Technical Advisory Council',
    responsibilities: ['Groundwater Conservation Advice', 'Environmental Impact Assessment', 'Solar Filtration Tech Review'],
    education: 'Ph.D. in Hydrogeology & Water Resources',
    professionalBackground: 'Distinguished researcher and water security consultant with global mountain watershed expertise.',
    displayOrder: 15,
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
    updatedAt: '2026-08-20T00:00:00Z'
  ...
  {
    id: 'lead_016',
    slug: 'medical-dialysis-advisor',
    name: 'Clinical Health Advisor (Seat)',
    role: 'Advisor - Dialysis Centers & Specialized Healthcare',
    category: 'advisor',
    bio: 'Advises the foundation on nephrology care, subsidized dialysis facility setups, and emergency cardiac health support for low-income patients.',
    department: 'Medical Advisory Council',
    responsibilities: ['Dialysis Unit Specifications', 'Clinical Protocol Standardization', 'Medical Equipment Vetting'],
    education: 'MD, DM (Nephrology), FASN',
    professionalBackground: 'Senior nephrologist dedicated to non-profit renal healthcare accessibility.',
    displayOrder: 16,
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
    updatedAt: '2026-08-20T00:00:00Z'
  ...
  {
    id: 'lead_017',
    slug: 'statutory-legal-advisor',
    name: 'Legal & Non-Profit Governance Advisor (Seat)',
    role: 'Advisor - Legal Frameworks & Cross-Border Compliance',
    category: 'advisor',
    bio: 'Guides foundation leadership on non-profit trust legislation, Section 80G renewals, FCRA compliance, and international NGO ethics.',
    department: 'Governance Advisory Council',
    responsibilities: ['Trust Governance Protocols', 'Cross-Border Compliance Review', 'Statutory Exemption Advice'],
    education: 'LL.M. in International Human Rights & Non-Profit Law',
    professionalBackground: 'Senior advocate with 25+ years in non-profit statutory law and charitable trust governance.',
    displayOrder: 17,
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
    updatedAt: '2026-08-20T00:00:00Z'
  ...
  {
    id: 'lead_018',
    slug: 'regional-coord-north-kashmir',
    name: 'North Kashmir Regional Coordinator (Seat)',
    role: 'Regional Volunteer Lead - Baramulla & Kupwara',
    category: 'volunteer_leader',
    bio: 'Coordinates volunteer mobilization, community verification surveys, and winter relief distribution across North Kashmir sectors.',
    department: 'Volunteer Task Force',
    responsibilities: ['Volunteer Onboarding & Briefing', 'Local Distribution Drives', 'Rapid Damage Assessment'],
    education: 'B.A. in Social Sciences',
    professionalBackground: 'Grassroots community organizer with extensive volunteer leadership experience.',
    displayOrder: 18,
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
    updatedAt: '2026-08-20T00:00:00Z'
  ...
  {
    id: 'lead_019',
    slug: 'regional-coord-south-kashmir',
    name: 'South Kashmir Regional Coordinator (Seat)',
    role: 'Regional Volunteer Lead - Anantnag & Pulwama',
    category: 'volunteer_leader',
    bio: 'Steers community outreach, clean water maintenance monitoring, and student mentorship teams across South Kashmir districts.',
    department: 'Volunteer Task Force',
    responsibilities: ['Community Outreach Hubs', 'Water Project Maintenance Checks', 'Youth Mentorship Drives'],
    education: 'B.Sc. in Information Technology',
    professionalBackground: 'Youth leader and volunteer organizer with deep roots in local village communities.',
    displayOrder: 19,
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
    updatedAt: '2026-08-20T00:00:00Z'
  ...
  {
    id: 'lead_020',
    slug: 'mountain-relief-lead',
    name: 'Mountain Emergency Relief Lead (Seat)',
    role: 'Disaster & Extreme Terrain Lead Volunteer',
    category: 'volunteer_leader',
    bio: 'Coordinates 4x4 volunteer relief convoys during winter snowstorms and floods in high-altitude mountain hamlets.',
    department: 'Volunteer Task Force',
    responsibilities: ['Emergency Convoy Navigation', 'Snowbound Village Delivery', 'First Aid & Triage Support'],
    education: 'Certified Mountain First Responder / Disaster Management Diploma',
    professionalBackground: 'Experienced high-altitude search, rescue, and mountain convoy logistician.',
    displayOrder: 20,
    isActive: true,
    createdAt: '2024-01-01T00:00:00Z',
    updatedAt: '2026-08-20T00:00:00Z'
