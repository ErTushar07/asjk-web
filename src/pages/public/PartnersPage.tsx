    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
      <div className="text-center space-y-3">
        ...
        <p className="text-content-secondary text-xs sm:text-sm max-w-xl mx-auto leading-relaxed">
          Collaborate with our foundation through Corporate Social Responsibility (CSR), institutional grants, technology partnerships, and sustainable developmental funding.
        </p>
      </div>
      ...
      {submitted ? (
        <div className="bg-white p-8 sm:p-12 rounded-3xl border border-content-border shadow-brand-md text-center space-y-4">
          ...
          <h3 className="text-2xl font-extrabold text-content-primary">Partnership Proposal Received</h3>
        ...
        <form onSubmit={handleSubmit} className="bg-white p-6 sm:p-10 rounded-3xl border border-content-border shadow-brand-sm space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-semibold text-content-primary mb-1">Organization / Foundation Name *</label>
              <input
                type="text"
                required
            ...
            <div>
              <label className="block text-xs font-semibold text-content-primary mb-1">Organization Type</label>
              <select
                value={orgType}
              ...
              >
                ...
                <option value="ngo">International Non-Profit / Foundation</option>
                <option value="government">Government / Multilateral Agency</option>
                <option value="academic">University / Academic Institution</option>
              </select>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              <label className="block text-xs font-semibold text-content-primary mb-1">Contact Person Name</label>
              <input
                type="text"
          ...
          <div>
            <label className="block text-xs font-semibold text-content-primary mb-1">Partnership Objectives & Scope</label>
            <textarea
              rows={4}
              required
